...
**Objective.** Instrument your agent stack (OpenCode + your code)
with logging/tracing, add human-in-the-loop checkpoints, and pull cost/usage
data from OpenCode. Then diagnose one real failure from your own traces
...
3. **Cost:** pull usage from `common.llm.STATS` or OpenCode logs (`~/.opencode/opencode.log`)
   and reconcile it against your own counts.
